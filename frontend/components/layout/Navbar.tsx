...
export default function Navbar() {
  ...
  const { data: searchResults, isLoading: isSearching } = useQuery({
    ...
    queryFn: () =>
      productService.searchProducts(debouncedSearchQuery, { limit: 5 }),
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        ...
        ((searchRef.current && !searchRef.current.contains(target)) ||
          (searchFormRef.current && !searchFormRef.current.contains(target))) &&
        cartMenuRef.current &&
  ...
  return (
    <nav
      className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-lg border-b border-secondary-200/60 shadow-soft transition-all duration-300"
      id="main-navbar"
      role="navigation"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                      ...
                      {cartItems.length === 0 ? (
                        ...
                        <div className="space-y-1">
                          {cartItems.slice(0, 5).map((item) => (
                            <div
                              key={item.id}
                              className="flex gap-3 p-3 rounded-xl hover:bg-primary-50/50 transition-all duration-300 group border border-transparent hover:border-primary-100"
                            >
                              ...
                              <button
                                ...
                                className="p-1.5 text-secondary-400 hover:text-red-500 hover:bg-red-50 rounded-md opacity-0 group-hover:opacity-100 transition-all"
                              >
                  ...
                  <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-float border border-secondary-200/60 overflow-hidden z-[100] animate-fade-in origin-top-right backdrop-blur-sm">
                    ...
                    <div className="p-2">
                      <Link
                        ...
                        className="block px-3 py-2.5 text-sm text-secondary-700 rounded-lg hover:bg-primary-50 hover:text-primary-700 transition-all duration-300 font-medium"
                      >
                        Dashboard
                      </Link>
                      <Link
                    ...
                    <div className="border-t border-secondary-200 p-2 bg-secondary-50/50">
                      <button
                        ...
                        className="w-full text-left px-3 py-2.5 text-sm text-red-600 rounded-lg hover:bg-red-50 transition-all duration-300 flex items-center gap-2 font-medium"
                      >
        ...
        <div className="hidden md:flex items-center justify-center gap-8 py-0">
          ...
          <Link
            href="/"
            className={cn(
              "text-sm font-semibold py-3 relative nav-link-underline transition-colors duration-300",
              pathname === "/"
        ...
        <div className="fixed inset-0 z-[200] bg-white animate-fade-in flex flex-col">
          <div className="flex items-center justify-between p-4 border-b border-secondary-100">
            ...
            <button
              ...
              className="p-2 text-secondary-500 rounded-full hover:bg-secondary-100"
            >
          ...
          <div className="p-4 flex-1 overflow-y-auto">
            <nav className="space-y-4">
              <Link
                href="/"
                onClick={() => setMobileMenuOpen(false)}
                className="block text-lg font-medium text-secondary-900 border-b border-secondary-100 pb-2"
              >
                Trang chủ
              </Link>
              <Link
