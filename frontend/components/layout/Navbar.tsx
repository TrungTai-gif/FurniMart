...
export default function Navbar() {
  ...
  return (
    <nav
      className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md border-b border-secondary-100 shadow-soft transition-all duration-300"
      role="navigation"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                  ...
                  <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-float border border-secondary-100 overflow-hidden z-[100] animate-fade-in origin-top-right">
                    ...
                    <div className="p-2">
                      <Link
                        ...
                        className="block px-3 py-2 text-sm text-secondary-700 rounded-md hover:bg-secondary-50 hover:text-primary-700 transition-colors"
                      >
                        Dashboard
                      </Link>
                      <Link
        ...
        <div className="hidden md:flex items-center justify-center gap-8 py-0">
          ...
          <Link
            href="/"
            className={cn(
              "text-sm font-medium py-3 border-b-2 transition-all duration-200",
              pathname === "/"
